-- WebCalendar Core PostgreSQL Schema (Target Architecture)
...
CREATE TABLE webcal_user (
  ...
  cal_telephone VARCHAR(60) DEFAULT NULL,
...
CREATE TABLE webcal_entry_user (
  cal_id INT DEFAULT '0' NOT NULL,
  cal_login VARCHAR(60) DEFAULT '' NOT NULL,
...
INSERT INTO webcal_config (cal_setting, cal_value) VALUES ('WEBCALENDAR_PROGRAM_VERSION', 'v4.0.1');
...
CREATE TABLE webcal_categories (
  ...
  cat_color VARCHAR(16) DEFAULT NULL,
...
CREATE TABLE webcal_blob (
  cal_blob_id SERIAL PRIMARY KEY,
  cal_id INT NULL,
  cal_login VARCHAR(60) NULL,
